          ...
          <div className="px-6 py-2 bg-white shadow-up">
            <form className="flex items-center" id="chat-form">
              <textarea
                ...
                placeholder="HI HI! You can do this... uphill both ways to school in the snow and all that ... Just tell me what you wanna figure out. From what channel NFL Redzone is on to how you can recover your <s>grindr</s> Nextdoor password."
              ></textarea>
              <button
                type="submit"
